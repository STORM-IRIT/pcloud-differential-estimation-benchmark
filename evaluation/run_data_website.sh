...
CONFIG_DIR="./configs_data_website"

OUTPUT_PTS_DIR="./data_website"
OUTPUT_JSON_DIR="./data_website_json"

PYTHON_SCRIPT="run_experiments.py"
PYTHON_SCRIPT_PTS_TO_JSON="convert_pts_to_web.py"
...
if [ $errors -eq 0 ]; then
    ...
    python3 "$PYTHON_SCRIPT_PTS_TO_JSON" "$OUTPUT_PTS_DIR" "$OUTPUT_JSON_DIR"
else
