...
void 
VarifoldsImpl<DataPoint, _NFilter, T>::init()
{
    Base::init();
...
template<class DataPoint, class _NFilter, typename T>
bool 
VarifoldsImpl<DataPoint, _NFilter, T>::addLocalNeighbor(
...
template<class DataPoint, class _NFilter, typename T>
FIT_RESULT 
VarifoldsImpl<DataPoint, _NFilter, T>::finalize()
{
    ...
    if ( ! m_planeIsReady ){
        ...
        const MatrixType A = m_nume / m_deno * Base::getNeighborFilter().evalScale(); /* const MatrixType A = m_nume / m_deno * Base::getNeighborFilter().evalScale(); */
...
template<class DataPoint, class _NFilter, typename T>
typename VarifoldsImpl<DataPoint, _NFilter, T>::Mat32 
VarifoldsImpl<DataPoint, _NFilter, T>::tangentPlane() const
{
    Mat32 B;
...
template<class DataPoint, class _NFilter, typename T>
void
VarifoldsImpl<DataPoint, _NFilter, T>::reorientPlane () {
...
template<class DataPoint, class _NFilter, typename T>
typename VarifoldsImpl<DataPoint, _NFilter, T>::VectorType 
VarifoldsImpl<DataPoint, _NFilter, T>::project(const VectorType& p) const
{
...
template<class DataPoint, class _NFilter, typename T>
typename VarifoldsImpl<DataPoint, _NFilter, T>::VectorType 
VarifoldsImpl<DataPoint, _NFilter, T>::primitiveGradient(const VectorType&) const
{
    return m_n_l0;
}
